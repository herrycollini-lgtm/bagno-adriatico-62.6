...
en: {
  ...
  "food.title":"The Bagno's kitchen, feet in the sand.",
  "food.p":"From breakfast to dinner, the kitchen follows the rhythm of the day: light at noon, more refined once the sun goes down.",
  "food.d1t":"Breakfast",
  "food.d1p":"Local pastries, homemade cakes, eggs and bacon, pancakes on request.",
  "food.d2t":"Lunch, beach picnic",
  "food.d2p":"Light, fresh dishes from Romagna tradition, served right at your lounger.",
  "food.d3t":"Candlelight dinner",
  "food.d3p":"After sunset, dinner on the terrace with a curated music selection.",
  ...
  "events.cta":"Book your spot",
  "sport.eyebrow":"Beach Arena & Active Life",
  "sport.title":"Play before you order the aperitivo.",
  "sport.p":"Four floodlit courts and the \"Resident Outsiders\" sport program: beach volley, footvolley, racket sports, SUP and yoga, between one swim and the next.",
  ...
  "rist.p":"A raised terrace over the water, candlelight after sunset, and a menu that ties the sea to Romagna tradition.",
  "rist.tab1":"Breakfast",
  "rist.tab2":"Lunch",
  "rist.tab3":"Dinner",
  "rist.tab4":"Private events",
...
de: {
  ...
  "food.eyebrow":"Food & Mixology",
  "food.title":"Die Küche des Bagno, mit den Füßen im Sand.",
  "food.p":"Vom Frühstück bis zum Abendessen folgt die Küche dem Rhythmus des Strandtages: leicht am Mittag, raffinierter nach Sonnenuntergang.",
  "food.d1t":"Frühstück",
  "food.d1p":"Regionales Gebäck, hausgemachte Kuchen, Eier mit Speck und Pancakes auf Wunsch.",
  "food.d2t":"Mittagessen, Beach Picnic",
  "food.d2p":"Leichte, frische Gerichte der Romagna-Tradition, direkt an der Liege serviert.",
  "food.d3t":"Abendessen bei Kerzenlicht",
  "food.d3p":"Nach Sonnenuntergang, Abendessen auf der Terrasse mit ausgewählter Musik.",
  ...
  "events.cta":"Jetzt Platz sichern",
  "sport.eyebrow":"Beach Arena & Active Life",
  "sport.title":"Spielen, bevor der Aperitivo kommt.",
  "sport.p":"Vier beleuchtete Plätze und das Sportprogramm \"Resident Outsiders\": Beach Volleyball, Footvolley, Racchettoni, SUP und Yoga.",
  ...
  "rist.p":"Eine erhöhte Terrasse über dem Wasser, Kerzenlicht nach Sonnenuntergang und eine Karte zwischen Meer und Romagna-Tradition.",
  "rist.tab1":"Frühstück",
  "rist.tab2":"Mittagessen",
  "rist.tab3":"Abendessen",
  "rist.tab4":"Private Feiern",
...
function initBookingForms(){
  document.querySelectorAll('form[data-booking]').forEach(form=>{
    form.addEventListener('submit', e=>{
      ...
      if(waLink) waLink.href = `https://wa.me/393477629132?text=${msg}`;
      const mailLink = form.querySelector('[data-mail-link]');
      if(mailLink) mailLink.href = `mailto:info@bagnoadriatico.com?subject=Richiesta%20prenotazione&body=${msg}`;
