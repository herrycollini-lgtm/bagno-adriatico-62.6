...
en: {
  ...
  "hero.title":"Your sunset has an address.",
  "hero.sub":"Beach club, gourmet terrace and sunset DJ sets on the Cesenatico shoreline. Premium loungers, chef-driven food, all day into the night.",
  "hero.cta1":"Reserve your spot in the sun",
  "hero.cta2":"Book a table",
...
de: {
  ...
  "hero.title":"Ihr Sonnenuntergang hat eine Adresse.",
  "hero.sub":"Beach Club, Gourmet-Terrasse und DJ-Sets bei Sonnenuntergang direkt an der Küste von Cesenatico. Premium-Liegen, Küche vom Chef, den ganzen Tag bis in die Nacht.",
  "hero.cta1":"Platz an der Sonne reservieren",
